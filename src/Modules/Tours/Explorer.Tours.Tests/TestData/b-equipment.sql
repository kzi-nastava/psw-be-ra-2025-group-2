...
VALUES(-1, 'Voda', 'Količina vode varira od temperature i trajanja ture. Preporuka je da se pije pola litre vode na jedan sat umerene fizičke aktivnosti (npr. hajk u prirodi bez značajnog uspona) po umerenoj vrućini');
