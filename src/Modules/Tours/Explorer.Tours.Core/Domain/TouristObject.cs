...
public class TouristObject : Entity
{
    ...
    private void Validate()
    {
        ...
        if (Latitude < -90 || Latitude > 90) throw new ArgumentException("Latitude must be between -90 and 90 degrees.");
        if (Longitude < -180 || Longitude > 180) throw new ArgumentException("Longitude must be between -180 and 180 degrees.");
    }
